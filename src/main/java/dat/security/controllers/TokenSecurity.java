...
import dat.security.controllers.ITokenSecurity;
...
public class TokenSecurity implements ITokenSecurity {
    ...
    public UserDTO getUserWithRolesFromToken(String token) throws ParseException {
        ...
        Long id = jwt.getJWTClaimsSet().getClaim("id") != null ? Long.parseLong(jwt.getJWTClaimsSet().getClaim("id").toString()) : null;
        return new UserDTO(username, rolesSet, id);
    }
